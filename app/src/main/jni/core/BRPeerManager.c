...
}; // New testnet, port:18770 useragent:"/Yerbas2.2.0/"

static const char *dns_seeds[] = {
//       "127.0.0.1", NULL
//        "192.168.86.38", NULL
        "seed-testnet-yerbas.yerbas.org.", "seed-testnet-yerbas.yerbas.org.",
        "seed-testnet-yerbas.bitactivate.com.", NULL
};
...
static const char *dns_seeds[] = {
//    "127.0.0.1", NULL
        "seed-yerbas.yerbas.org", "seed-yerbas.yerbas.org.", "seed-yerbas.bitactivate.com.", NULL
};
...
static void _mempoolDone(void *info, int success) {
    ...
    if (success) {
        ...
        BRPeerSendGetaddr(peer); // request a list of other yerbaswallet peers
        pthread_mutex_unlock(&manager->lock);
...
// specifies a single fixed peer to use when connecting to the yerbaswallet network
...
// connect to yerbas peer-to-peer network (also call this whenever networkIsReachable() status changes)
...
// publishes tx to yerbaswallet network (do not call TransactionFree() on tx afterward)
