...
import com.yerbaswallet.presenter.activities.ManageAssetsActivity;
...
import com.yerbaswallet.presenter.entities.BRSettingsItem;
...
import static com.yerbaswallet.R.layout.settings_list_item;
import static com.yerbaswallet.R.layout.settings_list_section;
...
//        }
        ...
        items.add(new BRSettingsItem(getString(R.string.Settings_review), "", new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent appStoreIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=" + "com.yerbaswallet"));
                    appStoreIntent.setPackage("com.android.vending");

                    startActivity(appStoreIntent);
                } catch (android.content.ActivityNotFoundException exception) {
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=" + "com.yerbaswallet")));
                }
                overridePendingTransition(R.anim.enter_from_right, R.anim.exit_to_left);
            }
        }, false));

        items.add(new BRSettingsItem(getString(R.string.Settings_aboutYerbas), "", new View.OnClickListener() {
            @Override
            public void onClick(View v) {
