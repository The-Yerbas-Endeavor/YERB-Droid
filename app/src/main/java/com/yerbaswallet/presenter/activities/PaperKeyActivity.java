...
import com.yerbaswallet.presenter.fragments.FragmentPhraseWord;
...
public class PaperKeyActivity extends BRActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (cleanPhrase.charAt(cleanPhrase.length() - 1) == '\0') {
            ...
            BRReportsManager.reportBug(new IllegalArgumentException("Paper Key error, please contact support at yerbaswallet.com: " + wordArray.length), true);
        } else {
