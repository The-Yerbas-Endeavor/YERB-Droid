...
import com.platform.chart.model.YERBToBTCData;
...
import com.yerbaswallet.presenter.AssetChangeListener;
import com.yerbaswallet.presenter.activities.settings.SecurityCenterActivity;
import com.yerbaswallet.presenter.activities.settings.SettingsActivity;
...
import com.yerbaswallet.presenter.customviews.BRNotificationBar;
import com.yerbaswallet.presenter.customviews.BRText;
import com.yerbaswallet.presenter.newTutorial.TutorialActivity;
...
import com.yerbaswallet.tools.manager.PromptManager;
import com.yerbaswallet.tools.services.SyncService;
...
import static com.yerbaswallet.presenter.activities.ManageAssetsActivity.IS_OWNED_ASSETS_VIEW_EXTRAS_KEY;
...
public class HomeActivity extends BRActivity implements InternetManager.ConnectionReceiverListener, AssetChangeListener {
    ...
    String CHART_URL = "https://bittrex.com/Api/v2.0/pub/market/GetTicks?marketName=BTC-YERB&tickInterval=day";
...
//        mWalletRecycler = findViewById(R.id.rv_wallet_list);
        ...
        BaseWalletManager wallet = YerbWalletManager.getInstance(this);
...
//            mTradePrice.setText("$0.0356254");
    ...
    private void getYERBValueHistory() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, CHART_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        YERBToBTCData data = new Gson().fromJson(response, YERBToBTCData.class);
    ...
    private void setChartData(YERBToBTCData data) {
        chartModel = new ChartModel()
                ...
                .series(
                        new SeriesElement[]{
                                new SeriesElement().name("YERB").data(
                                        data.toObjectArray()
                                ).lineWidth(1.0f)
                                        .step(true)
...
//            Log.d(TAG, "showNextPrompt: " + toShow);
    ...
    public void startObserving() {
        SyncService.startService(HomeActivity.this, YerbWalletManager.getInstance(this).getIso(this));
    }
