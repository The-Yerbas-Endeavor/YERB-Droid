...
import static com.yerbaswallet.R.layout.settings_list_toggle;
...
//                                                        m.wipeKeyStore(app);
    ...
    private void populateItems() {
        ...
        items.add(new BRSettingsItem(getString(R.string.YerbasNodeSelector_title), "", new View.OnClickListener() {
            @Override
            public void onClick(View v) {
