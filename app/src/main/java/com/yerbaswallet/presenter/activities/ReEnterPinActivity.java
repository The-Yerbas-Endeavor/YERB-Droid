...
//            Log.e(TAG, "verifyPin: SUCCESS");
            ...
            if (getIntent().getBooleanExtra("noPin", false)) {
                ...
                BRAnimator.showYerbSignal(this, getString(R.string.Alerts_pinSet), getString(R.string.UpdatePin_createInstruction), R.drawable.ic_check_mark_white, new BROnSignalCompletion() {
                    @Override
