...
import com.yerbaswallet.presenter.customviews.BRSearchBar;
import com.yerbaswallet.presenter.customviews.BRText;
import com.yerbaswallet.presenter.customviews.BaseTextView;
...
import com.yerbaswallet.tools.manager.FontManager;
import com.yerbaswallet.tools.manager.InternetManager;
import com.yerbaswallet.tools.manager.TxManager;
...
import static com.yerbaswallet.tools.animation.BRAnimator.t1Size;
import static com.yerbaswallet.tools.animation.BRAnimator.t2Size;
    ...
    */
    ...
    public void updateSyncProgress(double progress) {
        ...
        if (progress != SyncService.PROGRESS_FINISH) {
            ...
            if (mWallet instanceof YerbWalletManager) {
                YerbWalletManager yerbWalletManager = (YerbWalletManager) mWallet;
                long syncThroughDateInMillis = yerbWalletManager.getPeerManager().getLastBlockTimestamp() * DateUtils.SECOND_IN_MILLIS;
                String syncedThroughDate = new SimpleDateFormat(SYNCED_THROUGH_DATE_FORMAT).format(syncThroughDateInMillis);
                mSyncStatusLabel.setText(String.format(getString(R.string.SyncingView_syncedThrough), syncedThroughDate));
            }
        } else {
