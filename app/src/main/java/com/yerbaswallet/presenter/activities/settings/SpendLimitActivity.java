...
//            final long limit = BRKeyStore.getSpendLimit(app);
            ...
            String cryptoAmount = CurrencyUtils.getFormattedAmount(mContext, YerbWalletManager.ISO, new BigDecimal(item));
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    YerbWalletManager wallet = YerbWalletManager.getInstance(mContext);
                    if (wallet != null) {
