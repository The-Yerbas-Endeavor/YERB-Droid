...
import com.yerbaswallet.tools.security.SmartValidator;
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isWordCorrect(true) && isWordCorrect(false)) {
                    ...
                    BRAnimator.showYerbSignal(PaperKeyProveActivity.this, getString(R.string.Alerts_paperKeySet), getString(R.string.Alerts_paperKeySetSubheader), R.drawable.ic_check_mark_white, new BROnSignalCompletion() {
                        @Override
