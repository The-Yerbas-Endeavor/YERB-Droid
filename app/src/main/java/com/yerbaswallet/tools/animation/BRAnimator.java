package com.yerbaswallet.tools.animation;
...
import com.yerbaswallet.presenter.activities.HomeActivity;
import com.yerbaswallet.presenter.activities.LoginActivity;
...
import com.yerbaswallet.presenter.fragments.BurnFragmentListener;
import com.yerbaswallet.presenter.fragments.FragmentAddAddress;
import com.yerbaswallet.presenter.fragments.FragmentAssetMenu;
import com.yerbaswallet.presenter.fragments.FragmentBurnAsset;
import com.yerbaswallet.presenter.fragments.FragmentConfirmation;
import com.yerbaswallet.presenter.fragments.FragmentCreateAsset;
import com.yerbaswallet.presenter.fragments.FragmentData;
import com.yerbaswallet.presenter.fragments.FragmentIPFS;
import com.yerbaswallet.presenter.fragments.FragmentIssueSubAsset;
import com.yerbaswallet.presenter.fragments.FragmentIssueUniqueAsset;
import com.yerbaswallet.presenter.fragments.FragmentManageAsset;
import com.yerbaswallet.presenter.fragments.FragmentMenu;
import com.yerbaswallet.presenter.fragments.FragmentReceive;
import com.yerbaswallet.presenter.fragments.FragmentRequestAmount;
import com.yerbaswallet.presenter.fragments.FragmentSend;
import com.yerbaswallet.presenter.fragments.FragmentSignal;
import com.yerbaswallet.presenter.fragments.FragmentSupport;
import com.yerbaswallet.presenter.fragments.FragmentTransferAsset;
import com.yerbaswallet.presenter.fragments.FragmentTxCreated;
import com.yerbaswallet.presenter.fragments.FragmentTxDetails;
...
public class BRAnimator {
    ...
    public static void showYerbSignal(Activity activity, String title, String iconDescription, int drawableId, BROnSignalCompletion completion) {
...
//    }
    ...
    public static void startYerbIfNotStarted(Activity app) {
        if (!(app instanceof HomeActivity))
            startYerbActivity(app, false);
    }

    public static void startYerbActivity(Activity from, boolean auth) {
        if (from == null) return;
        Log.e(TAG, "startYerbActivity: " + from.getClass().getName());
