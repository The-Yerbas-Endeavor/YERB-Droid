...
public class WalletListAdapter extends RecyclerView.Adapter<WalletListAdapter.WalletItemViewHolder> {
    ...
    private String CHART_URL = "https://bittrex.com/Api/v2.0/pub/market/GetTicks?marketName=BTC-YERB&tickInterval=day";
...
//            holder.mTradePrice.setText("$0.0356254");
        ...
        if (!chartLoaded)
            getYERBValueHistory(holder.mChart);
...
//    }
    ...
    private void getYERBValueHistory(final ChartView chartView) {
...
//                chartView.setVisibility(View.GONE);
    ...
    private void setChartData(ChartView chartView, YERBToBTCData data) {
