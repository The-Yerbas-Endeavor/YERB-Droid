...
import com.yerbaswallet.tools.listeners.SyncReceiver;
...
public class YerbasApp extends Application {

    private static final String TAG = YerbasApp.class.getName();
    public static int DISPLAY_HEIGHT_PX;
    FingerprintManager mFingerprintManager;
    // host is the server(s) on which the API is hosted
    public static String HOST = "api.yerbaswallet.org";
...
//    public static Map<String, String> getYerbHeaders() {
//        return mHeaders;
//    }

    public static Context getYerbContext() {
    ...
    public static void setYerbContext(Activity app) {
        currentActivity = app;
    }
